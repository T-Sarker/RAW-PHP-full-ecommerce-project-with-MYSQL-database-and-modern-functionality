...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['submit'])) {
        ...
        $insertBanner = $bc->bottomBannerInsertIntoDB($_POST,$_FILES);
    }
    ...
    if (!empty($_GET['Delete']) && isset($_GET['Delete'])) {
        ...
        $deleteItem = $bc->deleteBottomBannerFromDB($id);
    }
?>
...
<div id="right-panel" class="right-panel">
            ...
            <div class="row mb-2">
                <div class="col">
                    <div class="form-group">
                        ...
                        <small>Size: 262px X 265px</small>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
    ...
    <div class="col-10">
        ...
        <?php
            $getTopBanner = $bc->getLastBottomBannerFromDB();
